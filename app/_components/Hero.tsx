...
const Hero = () => {
  ...
  return (
    <BlurFade
      ...
      direction="up"
    >
      <h1 className="text-4xl md:text-6xl font-semibold text-shadow ">
        Ehsan Mosaddeghi
      </h1>
      <h1 className="text-4xl md:text-6xl font-semibold text-shadow">
        Front-End Developer
      ...
      <p className="opacity-60 text-lg max-w-xl text-center">
        {age}-year-old self-taught frontend developer with a passion for
        learning and crafting innovative user experiences. Enthusiastic about
