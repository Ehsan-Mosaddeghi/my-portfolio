...
const ProjectItem: React.FC<{ project: Project }> = ({ project }) => {
  return (
    <a
      href={project.live}
      target="_blank"
      className="relative   justify-center items-center group ring-1 ring-stone-400 dark:ring-stone-700 z-10 flex  flex-col p-2 rounded-lg bg-zinc-400 dark:bg-zinc-600 hover:shadow-lg"
    >
      ...
      <div className=" overflow-hidden relative w-full h-full min-w-[400px] min-h-[250px] rounded-md ">
        <Image
